...
public final class DatabaseConnection {
    ...
    // Obtiene una conexiÃ³n nueva usando config.properties (db.url, db.user, db.password, db.driver)
    ...
    private static Properties loadProperties() {
        ...
        try (InputStream in = Thread.currentThread()
            ...
            if (in == null) {
                throw new RuntimeException("No se encontrÃ³ " + CONFIG_FILE + " en resources.");
            }
            props.load(in);
            return props;
        } catch (IOException e) {
    ...
    // Cierra la conexiÃ³n sin lanzar excepciÃ³n
